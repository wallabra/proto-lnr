...
export const TR_PT_BR: TranslationTable = {
  translation: {
    ...
    "hud.pickup_one": "Pegou um {{pickup}}",
    "hud.pickup_other": "Pegou {{count}} {{pickup}}",
    ...
    "shopinfo.cannotUninstall": "Cannot uninstall without destroying!",
    ...
    "projectile.modifier.blackhole": "carga de buraco negro!",

    "fueltype.coal": "carvão",
    "fueltype.diesel": "díesel",

    "itemtype.crewmate_one": "marujo",
    "itemtype.crewmate_other": "marujos",
    "itemtype.food_one": "comida",
    "itemtype.food_other": "comida",
    "itemtype.cannon_one": "canhão",
    "itemtype.cannon_other": "canhões",
    "itemtype.engine_one": "motor",
    "itemtype.engine_other": "motores",
    "itemtype.vacuum_one": "aspirador",
    "itemtype.vacuum_other": "aspiradores",
    "itemtype.cannonballAmmo_one": "bola de canhão",
    "itemtype.cannonballAmmo_other": "bolas de canhão",
    "itemtype.fuel_one": "combustível",
    "itemtype.fuel_other": "combustível",
    "itemtype.valuable_one": "mercadoria",
    "itemtype.valuable_other": "mercadorias",
    "itemtype.armor_one": "blindagem",
    "itemtype.armor_other": "blindagens",
    ...
    "intermission.drydock.part.action.destroy": "Destruir",
