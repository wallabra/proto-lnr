export const TR_PT_BR = {
  translation: {
    "main.title": "Loot & Roam",
    "main.version": "Protótipo v{{game_version}}",
    ...
    "submeun.newgame.comingsoon": "(Outros modos virão logo, logo!)",
    ...
    "submenu.help.rows": [
      ...
      2,
      { text: "Quando você estiver longe o suficiente da ilha, aperte L para sair para a Intermissão!", color: "#FFA" },
      2,
      [
        ...
        1,
        "Quando você estiver satisfeito/a com a gerência, vá ao menu de Cartografia para Invadir a Próxima Ilha! Arrr!!"
      ],
    ],
    ...
    "hud.status.ripPrompt": "(Aperte R para resetar, ou M para voltar ao menu principal!)",
    ...
    "shopinfo.manning.needsInterp": "exige {{manned}} de força total dos operadores",
    ...
    "shopinfo.cannon.shootRate": "shots per minute: {{spm}}",
    "shopinfo.cannon.spread": "spread (°): {{spread}}",
    "shopinfo.cannon.range": "max. range (m): {{rangeMeters}}",
    "shopinfo.vacuum.range": "attract range (m): {{suckRadiusMeters}}",
    "shopinfo.vacuum.strength": "attract power (N/sqrt(m)): {{suckStrengthMeters}}",
    ...
    "intermission.drydock.stats.salary.info.insufficient": "Você precisa de {{money}} para pagar os salários amanhã, sendo {{salary}}/dia. Senão, os marujos poderão grevear daqui a {{strikesIn}} dias.",
    "intermission.drydock.stats.salary.info.sufficient": "Você tem dinheiro o suficiente para cobrir as demandas salariais de {{salary}}/dia.",
    "intermission.drydock.stats.food.info.head": "Você tem {{food}} pontos de comida; sua tripulação consome {{totalIntake}}/dia.",
    "intermission.drydock.stats.food.info.insufficient": "Se você não tratar essa crise de fome, sua tripulação inteira VAI grevear!",
    "intermission.drydock.stats.food.info.sufficient": "Você tem comida suficiente para {{days}} dias.",
    "intermission.drydock.stats.repairs.info.intact": "Seu navio está completamente em boa condição e não precisa de reparos.",
    "intermission.drydock.stats.repairs.info.damaged.insufficient": "Seu navio está danificado, e você vai precisar de mais {{missingMoney}} para consertar tudo, o que custará {{totalCost}}.",
    "intermission.drydock.stats.repairs.info.damaged.sufficient": "Seu navio está danificado, e você tem dinheiro o suficiente para todos os consertos - que juntos custarão {{totalCost}}.",
    "intermission.drydock.stats.weight.info": "Seu navio pesa, ao todo, {{totalWeight}}; {{hullWeight}} disso é o casco.",
    "intermission.drydock.stats.engines.info": "Seu navio, com seu arranjo e situação atual de motores, pode impulsionar-se a {{totalThrust}} kN/s.",
    "intermission.drydock.stats.engines.info.none": "Seu navio está sem motores funcionais. Verifique o combustível e a operação dos marujos.",
    "intermission.drydock.stats.fuel.info.head": "{{which}} de seus {{numEngines}} motores instalados têm combustível.",
    "intermission.drydock.stats.fuel.info.need": "Você vai precisar de mais: {{missingFuelTypes}}",
    "intermission.drydock.stats.ammo.info.head": "{{which}} de seus {{numCannons}} canhões estão munidos.",
    "intermission.drydock.stats.ammo.info.need": "Você precisa de mais bolas de canhão dos calibres: {{missingCalibers}}",
    "intermission.drydock.stats.manned.info": "Das {{numParts}} partes instaladas em seu navio, {{numNeedManned}} são manualmente operadas. Destas, {{numManned}} têm marujos operando-as.",
    ...
    "intermission.harbor.ship.action.switch": "Comprar & Trocar Principal ({{cost}})",
    "intermission.harbor.ship.action.buy": "Comprar & Adicionar à Frota ({{cost}})",
