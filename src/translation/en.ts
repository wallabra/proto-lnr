...
export const TR_EN: TranslationTable = {
	translation: {
		...
		"hud.pickup_one": "Picked up a {{pickup}}",
		"hud.pickup_other": "Picked up {{count}} {{pickup}}",
		...
		"hud.startDay":
			"You reach the island on the beginning of day {{day, number}}.",
		...
		"itemtype.crewmate_one": "crewmate",
		"itemtype.food_one": "food",
		"itemtype.cannon_one": "cannon",
		"itemtype.engine_one": "engine",
		"itemtype.vacuum_one": "vacuum",
		"itemtype.cannonballAmmo_one": "cannonball",
		"itemtype.fuel_one": "fuel",
		"itemtype.valuable_one": "loot",
		"itemtype.armor_one": "armor",
		"itemtype.crewmate_other": "crewmates",
		"itemtype.food_other": "food",
		"itemtype.cannon_other": "cannons",
		"itemtype.engine_other": "engines",
		"itemtype.vacuum_other": "vacuums",
		"itemtype.cannonballAmmo_other": "cannonballs",
		"itemtype.fuel_other": "fuel",
		"itemtype.valuable_other": "loot",
		"itemtype.armor_other": "armor",
		...
		"intermission.drydock.part.action.destroy": "Destroy",
